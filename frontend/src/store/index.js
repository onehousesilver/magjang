...
export default createStore({
  ...
  actions: {  // mutations 호출, 비동기 가능
    setUser: function ({commit}, userId, nickName, rankPoint, naverId, winAmount, gangAmount, proGangAmount, lastGenRoom) {
      commit('SET_USER', userId, nickName, rankPoint, naverId, winAmount, gangAmount, proGangAmount, lastGenRoom)
    },
